...
df_att = pd.read_csv("Week 9 - Machine Learning III/Case_Study_Scotium/scoutium_attributes.csv", sep=";")
df_pot_labels = pd.read_csv("Week 9 - Machine Learning III/Case_Study_Scotium/scoutium_potential_labels.csv", sep=";")
...
# Mehmet'in bu adımda kullandığı fonksiyon
def voting_classifier(best_models, X, y):
    ...
    voting_clf = VotingClassifier(estimators=[('RF', best_models["RF"]),
                                  ...
                                  voting='soft').fit(X, y)  # burada voting='soft' yerine 'hard' da denenebilir...
